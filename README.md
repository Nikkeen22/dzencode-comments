...
> Для локального запуску див. розділ "Швидкий старт" нижче.
...
- ✅ Кешування списку коментарів через Redis (10 секунд)
...
- **API бекенду:** http://localhost/api/
- **Адмін-панель Django:** http://localhost/admin/
...
DB_PASSWORD=твій-пароль-бд
ALLOWED_HOSTS=your-domain.com
CORS_ALLOWED_ORIGINS=https://your-domain.com
```

### 4. Генерація SECRET_KEY
